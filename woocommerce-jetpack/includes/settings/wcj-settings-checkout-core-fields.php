...
$settings = array(
	...
	array(
		...
		'help_text' => __( 'Choose which field settings to use when both billing and shipping have the same field. Billing is recommended as it is typically the primary address.', 'woocommerce-jetpack' ),
	),
	array(
		...
		'help_text' => __( 'Some countries change field labels and requirements automatically (e.g., "State" vs "Province"). Choose how to handle these country-specific adjustments.', 'woocommerce-jetpack' ),
	),
	array(
		...
		'default'   => 'no',
		'help_text' => __( 'Force fields to appear in the exact order you set. Enable this if your theme ignores the priority settings and fields appear in the wrong order.', 'woocommerce-jetpack' ),
	),
	array(
		...
		'default'           => 'and',
		'help_text'         => __( 'How to evaluate multiple category conditions. "And" means all conditions must match, "Or" means any single condition is enough.', 'woocommerce-jetpack' ),
	),
	array(
		'id'   => 'wcj_checkout_core_fields_general_options',
		'type' => 'sectionend',
