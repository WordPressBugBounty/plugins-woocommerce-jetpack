...
$settings = array(
	...
	array(
		...
		'default'   => 3,
		'type'      => 'number',
		'help_text' => __( 'How many related products to display. Most stores use 3-4 products. More products may overwhelm customers, fewer may not provide enough alternatives.', 'woocommerce-jetpack' ),
	),
	array(
		...
		'default'   => 3,
		'type'      => 'number',
		'help_text' => __( 'Number of columns in the related products grid. Match this to your products number for a clean single row, or use fewer columns for larger product images.', 'woocommerce-jetpack' ),
	),
	array(
		'id'   => 'wcj_product_info_related_products_general_options',
		'type' => 'sectionend',
	...
	array(
		...
		'help_text' => __( 'How to sort related products. Random shows variety each page load. Date shows newest products first. Price helps customers compare similar items.', 'woocommerce-jetpack' ),
	),
);
if ( WCJ_IS_WC_VERSION_BELOW_3 ) {
...
$settings = array_merge(
	...
	array(
		...
		array(
			...
			'default'   => 'yes',
			'type'      => 'checkbox',
			'help_text' => __( 'Show products from the same category. This is the most common and effective way to show relevant alternatives that customers are likely to consider.', 'woocommerce-jetpack' ),
		),
		array(
			...
			'default'   => 'yes',
			'type'      => 'checkbox',
			'help_text' => __( 'Show products with the same tags. Useful for cross-category relationships like "organic" or "bestseller" that span multiple categories.', 'woocommerce-jetpack' ),
		),
		array(
			...
			'default'   => 'no',
			'type'      => 'checkbox',
			'help_text' => __( 'Show products with matching attributes like color, size, or brand. Great for fashion or electronics stores where customers shop by specific features.', 'woocommerce-jetpack' ),
		),
		array(
		...
		array(
			...
			'default'   => 'no',
			'type'      => 'checkbox',
			'help_text' => __( 'Completely remove the related products section from product pages. Use the category/tag filters below to hide only for specific products.', 'woocommerce-jetpack' ),
		),
		array(
