...
if ( ! class_exists( 'WCJ_Export_Fields_Helper' ) ) :
	...
	class WCJ_Export_Fields_Helper {
		 ...
		 * @since   2.5.9
		 */
		public function get_customer_from_order_export_fields() {
			return array(
		 ...
		 * @since   2.5.9
		 */
		public function get_customer_from_order_export_default_fields_ids() {
			return array(
				'customer-nr',
		 ...
		 * @since   2.5.9
		 */
		public function get_customer_export_fields() {
			return array(
		 ...
		 * @since   2.5.9
		 */
		public function get_customer_export_default_fields_ids() {
			return array(
				'customer-id',
				'customer-email',
				'customer-first-name',
		 ...
		 * @since   2.5.9
		 */
		public function get_order_items_export_fields() {
			return array(
		 ...
		 * @since   2.5.9
		 */
		public function get_order_items_export_default_fields_ids() {
			return array(
				'order-number',
				'order-status',
				'order-date',
		 ...
		 * @since   2.5.6
		 */
		public function get_order_export_fields() {
			return array(
				'order-id'                         => __( 'Order ID', 'woocommerce-jetpack' ),
				'order-number'                     => __( 'Order Number', 'woocommerce-jetpack' ),
				'order-status'                     => __( 'Order Status', 'woocommerce-jetpack' ),
		 ...
		 * @since   2.5.6
		 */
		public function get_order_export_default_fields_ids() {
			return array(
				'order-id',
				'order-number',
				'order-status',
		 ...
		 * @since   2.5.7
		 */
		public function get_product_export_fields() {
			return array(
		 ...
		 * @since   2.5.7
		 */
		public function get_product_export_default_fields_ids() {
			return array(
				'product-id',
				'product-name',
				'product-sku',
